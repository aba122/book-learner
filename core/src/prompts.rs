...
只输出 JSON,不要别的文字:\n\
{{\"nodes\":[{{\"id\":\"短id\",\"title\":\"节点名(≤12字)\",\"summary\":\"一句话≤30字,卡片上显示\",\"detail\":\"1-3句展开:讲了什么、为何重要\",\"kind\":\"阶段|主题|概念|转折|事件\",\"blockIds\":[相关知识块号],\"spineHrefs\":[\"所在章节href\"]}}],\
\"edges\":[{{\"from\":\"id\",\"to\":\"id\",\"label\":\"关系(≤6字,如 转向/因为/递进)\"}}]}}\n\
要求:节点 8-20 个为宜、不超过 40,**按书中出现的先后排列**;id 唯一且简短;只覆盖下面列出的已读章节,别剧透后文;summary 具体到内容不空话;每个节点 spineHrefs 至少给一个(用下面的 href),blockIds 用下面的号;边要连成一条能看出主线的脉络,别只给孤立节点。\n\n\
=== 已读章节(href 标题)===\n{chapters}\n\n=== 已读范围的知识块(#号 [模块] 标题)===\n{blocks}\n\n\
