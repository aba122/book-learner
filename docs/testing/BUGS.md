...
| BL-010 | P3 | open(已退回) | 阅读器 | 用户口述(09-09 19:0x):"翻页可以加上翻书的那种显示特效,而不是干巴巴的翻页";换包 21c2803 后口述(09-11 11:2x):"我要的是纸质书翻页的那种特效";换包 6dc0831 后口述(09-11 13:5x):"翻书功能做得不好,退回上个版本先吧" | 无过渡;滑入(PR #40)不算;3D 两拍翻页(PR #41)观感不好 | PR #42 退回 PR #40 的滑入过渡(保留 BL-002/003)。**下一次做之前先问清用户不满意的点**(立起角度/速度/纸背素纸/双页整跨?);真正的纸质卷页需要页面快照(克隆 iframe 文档),大章代价大,要单独评估 | reader.test「BL-010」「BL-009」 | 09-09(用户);09-11 返工;09-11 退回 |
