...
| BL-014 | P2 | open | 阅读器/问书 | 用户口述(09-17):“问书的对话界面太小了,不好看内容” | 问书面板在右栏卡片里固定 w-72(288px),消息区窄 | 待定:加宽问书面板 / 可展开为宽栏或全屏对话 / 折叠正文腾地方 | 待补 | 09-17(用户) |
| BL-015 | P2 | open | 阅读器/问书 | 用户口述(09-17):AI 回复里出现 **加粗** 等原始星号,希望对话更清晰美观 | 第一批刻意用纯文本 whitespace-pre-wrap 显示、未渲染 Markdown(当时按 YAGNI 不引库,见 DEVLOG 2026-09-16) | 待定:渲染 Markdown(加轻量渲染,注意 XSS/CSP)+ 气泡排版打磨(标题/列表/加粗/代码) | 待补 | 09-17(用户) |
